...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mBottomControlsBackgroundColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_BOTTOM_CONTROLS_BACKGROUND_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_widget_background));
