...
import com.androidbull.meme.generator.helper.FILE_PROVIDER_AUTHORITY
import com.androidbull.meme.generator.helper.FRAGMENT_CUSTOM_MEME_BOTTOM_SHEET_TAG
...
import com.androidbull.meme.generator.ui.adapter.MainPagerAdapter
import com.androidbull.meme.generator.ui.dialogs.CustomMemeBottomSheet
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        /*  when (resultCode) {
              Activity.RESULT_OK -> {
                  ...
                  intent.putExtra("customMemePath", filePath)
                  startActivity(intent)
