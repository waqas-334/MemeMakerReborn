...
import com.androidbull.meme.maker.helper.sendEmail

class RateConfusedFragment : Fragment() {

    companion object {
        fun newInstance() = RateConfusedFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_rate_confused, container, false)
    }
