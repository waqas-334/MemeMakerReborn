...
import com.androidbull.meme.maker.helper.CheckableImageButton
        ...
        fun bind(meme: Meme2) {
            ...
            if (StorageHelper.isExternalStorageReadable()) {
                Glide.with(itemView.context)
                    .load(StorageHelper.getTemplatesPrivateDir() + meme.imageName)
